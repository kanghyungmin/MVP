...
import CommunityFeature from "./component/communityFeature";
import VotingFeature from "./component/votingFeature";
import TicketingFeature from "./component/ticketingFeature";
...
export default function Home() {
  return (
    <>
      ...
      {/* Hero Image-SM */}
      <div className="sm:hidden w-full bg-neutral-950 relative">
      ...
      <VotingFeature></VotingFeature>
      <TicketingFeature></TicketingFeature>
    </>

...
export default function Home() {
  return (
    <header>
      ...
      {/* Hero Image-SM */}
      <div className="sm:hidden w-full h-[541px] relative bg-neutral-950">
        ...
        <div className="w-full pb-[1px] bg-neutral-500 relative justify-center items-center inline-flex z-10">
          <img
